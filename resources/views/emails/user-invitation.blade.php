...
<head>
    ...
    <title>Undangan Akses Admin Panel</title>
    <style>
        ...
        .button { display: inline-block; padding: 12px 24px; background-color: #1A6FAA; color: #ffffff; text-decoration: none; border-radius: 8px; font-weight: 500; }
...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Halo {{ $user->name }},</p>
            <p>Anda telah diundang untuk mengakses Admin Panel <strong>{{ \App\Models\SiteSetting::getValue('site_name', config('app.name')) }}</strong>.</p>
            <p>Silakan login menggunakan email dan password yang telah diberikan oleh administrator.</p>
            <p style="text-align: center; margin: 32px 0;">
                <a href="{{ route('admin.dashboard') }}" class="button">Buka Admin Panel</a>
            </p>
